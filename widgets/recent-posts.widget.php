<?php
/**
 * Combunity Recent Posts Widget for the cpost post type
 *
 * @since 1.0.0
 * @package Combunity
 */

class Combunity_Widget_Recent_Posts extends WP_Widget {

	public function __construct() {
		$widget_ops = array( 'classname' => 'widget_recent_threads', 'description' => __( 'Your site’s most recent custom Posts.', 'custom-post-type-widgets' ) );
		parent::__construct( 'custom-post-type-recent-posts', __( 'Combunity Recent Threads' ), $widget_ops );
		$this->alt_option_name = 'combunity_cpost_recent_threads';
	}
